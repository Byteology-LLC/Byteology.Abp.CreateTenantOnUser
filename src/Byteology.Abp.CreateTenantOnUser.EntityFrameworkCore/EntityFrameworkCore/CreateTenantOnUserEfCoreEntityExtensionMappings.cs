...
public static class CreateTenantOnUserEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE CreateTenantOnUserModuleExtensionConfigurator CLASS (in the Domain.Shared project)
